// ==================================================
// Program Name   : 20251127161928_SyncProviderOwnerSnapshot.Designer.cs
// Purpose        : EF Core migration designer for syncing provider owner snapshot
...
namespace ApiApp.Migrations
{
    ...
    [Migration("20251127161928_SyncProviderOwnerSnapshot")]
    partial class SyncProviderOwnerSnapshot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiApp.Models.Merchant", b =>
                {
                    b.HasOne("ApiApp.Models.User", "OwnerUser")
                        .WithOne("Merchant")
                        .HasForeignKey("ApiApp.Models.Merchant", "OwnerUserId")
                        .OnDelete(DeleteBehavior.Restrict);
